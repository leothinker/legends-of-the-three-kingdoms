  ...
  skill: {
    ...
    fangtian_guozhan: {
      ...
      async cost(event, trigger, player) {
        ...
        function filterTarget(_card, player, target) {
      ...
      subSkill: {
        trigger: {
          ...
          filter(event, player) {
            return player
              .getStorage("fangtian_guozhan_trigger")
              .includes(event.card)
          },
          silent: true,
          onremove: true,
          ...
          async content(event, trigger, player) {
            if (
              event.triggername === "shaMiss" &&
              player.getStorage(event.name).includes(trigger.card)
            ) {
