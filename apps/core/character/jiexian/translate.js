...
const translates = {
  ...
  jx_rende: "仁德",
  jx_rende_info:
    "出牌阶段对每名角色限一次，你可以将任意张手牌交给一名其他角色，当此阶段内你以此法给出第二张牌时，你可以视为使用一张基本牌。",
  jijiang: "激将",
  jijiang_info:
    "主公技，当你需要使用或打出【杀】时，你可以令其他蜀势力角色选择是否替你使用或打出（视为由你使用或打出）。",
  ...
  yijue: "义绝",
  yijue_info:
    "出牌阶段限一次，你可以弃置一张牌，然后令一名其他角色展示一张手牌。若此牌为黑色，则直到回合结束其不能使用或打出手牌且所有非锁定技失效，你对其使用的♥【杀】伤害+1；若此牌为红色，则你获得之，然后你可以令其回复1点体力。",

  jx_zhangfei: "界张飞",
  jx_zhangfei_prefix: "界",
  jx_paoxiao: "咆哮",
  jx_paoxiao_info:
    "锁定技，你使用【杀】无次数限制；若你于当前阶段使用过【杀】，则你于此阶段使用【杀】无距离限制。",
  tishen: "替身",
  tishen_info:
    "出牌阶段结束时，你可以展示所有牌并弃置其中的锦囊牌与坐骑牌，然后直到你的下回合开始，获得所有以你为目标且未对你造成伤害的【杀】。",
  ...
  yajiao: "涯角",
  yajiao_info:
    "当你于回合外使用或打出手牌时，你可以展示牌堆顶的一张牌并交给一名角色。若此牌与你使用或打出的牌类别不同，你弃置一张牌。",
  ...
  jx_tieji: "铁骑",
  jx_tieji_info:
    "当你使用【杀】指定目标后，你可以令该角色的非锁定技于此回合内失效，然后你进行判定，除非其弃置一张与结果花色相同的牌，否则其不能使用【闪】响应此【杀】。",

  jx_huangyueying: "界黄月英",
  jx_huangyueying_prefix: "界",
  jx_jizhi: "集智",
  jx_jizhi_info:
  ...
  jx_jiuyuan: "救援",
  jx_jiuyuan_info:
    "主公技，其他吴势力角色对其使用【桃】时，若其体力值大于你，则该角色可以改为令你回复1点体力，然后其摸一张牌。",
  ...
  jx_sunshangxiang: "界孙尚香",
  jx_sunshangxiang_prefix: "界",
  jx_jieyin: "结姻",
  jx_jieyin_info:
  ...
  jx_xiahoudun: "界夏侯惇",
  jx_xiahoudun_prefix: "界",
  jx_ganglie: "刚烈",
  jx_ganglie_info:
    "当你受到1点伤害后，你可以进行判定，若结果为：红色，你对伤害来源造成1点伤害；黑色，你弃置其一张牌。",
  qingjian: "清俭",
  qingjian_info:
    "每名角色的回合限一次，当你在摸牌阶段外获得牌后，你可以展示任意张牌并交给一名其他角色，然后令当前回合角色此回合手牌上限+X（X为你此次展示牌的类别数）。",

  jx_zhangliao: "界张辽",
  jx_zhangliao_prefix: "界",
  jx_tuxi: "突袭",
  jx_tuxi_info: "摸牌阶段，你可以少摸任意张牌并选择等量其他角色，然后获得这些角色的各一张手牌。",

  jx_xuchu: "界许褚",
  jx_xuchu_prefix: "界",
  jx_luoyi: "裸衣",
  jx_luoyi_info:
    "摸牌阶段开始时，你亮出牌堆顶的三张牌，然后你可以获得其中的基本牌、武器牌和【决斗】，若如此做，则你放弃摸牌，且直到你的下回合开始，当你为伤害来源的【杀】或【决斗】造成伤害时，此伤害+1。",
  ...
  jx_yiji: "遗计",
  jx_yiji_info: "当你受到1点伤害后，你可以摸两张牌，然后你可以将至多两张手牌交给一或两名其他角色。",

  jx_zhenji: "界甄姬",
  jx_zhenji_prefix: "界",
  jx_qingguo: "倾国",
  jx_qingguo_info: "你可以将一张黑色牌当【闪】使用或打出。",
  luoshen: "洛神",
