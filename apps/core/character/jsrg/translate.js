...
const translates = {
  ...
  jsrgguanhuo: "观火",
  jsrgguanhuo_info:
    "出牌阶段，你可以视为使用一张【火攻】。你以此法使用的未造成过伤害的【火攻】结算结束后，若你此阶段发动〖观火〗的次数：为1，则你于此阶段使用【火攻】造成的伤害+1；不为1，你失去〖观火〗。",
  jsrgjuxia: "居下",
  jsrgjuxia_info:
    "每回合限一次。当其他角色使用牌指定你为目标后，若其技能数多于你，其可以令此牌对你无效，然后令你摸两张牌。",
  jsrg_new_juxia: "居下",
  jsrg_new_juxia_info:
    "每回合限一次。当其他角色使用牌指定你为目标后，若其技能数多于你，你可摸两张牌。",
  jsrg_xushao: "起许劭",
  ...
  jsrgshichong: "恃宠",
  jsrgshichong_info:
    "转换技。当你使用牌指定其他角色为唯一目标后，阳：你可以获得目标角色一张手牌；阴：目标角色可以交给你一张手牌。",
  jsrglianzhu: "连诛",
  jsrglianzhu_info:
    "出牌阶段限一次。你可以展示一张黑色手牌并交给一名其他角色，然后视为你对所有与其势力相同的其他角色依次使用一张【过河拆桥】。",
  jsrg_new_lianzhu: "连诛",
  jsrg_new_lianzhu_info:
    "结束阶段，你可视为使用一张【过河拆桥】，结算后此牌唯一目标须选择一项：1.失去1点体力；2.令你对其下家发动〖连诛〗。",
  jsrg_qiaoxuan: "起桥玄",
  ...
  jsrg_new_juezhi: "绝质",
  jsrg_new_juezhi_info:
    "①当你失去一张装备区里的装备牌后，你可以废除对应的装备栏并摸两张牌。②一名角色于你的回合内受到伤害时，若其装备区中有与你已废除装备栏副类别相同的牌，你可以令此伤害+1。",
  jsrgjizhao: "急召",
  jsrgjizhao_info:
  ...
  jsrgjishan: "积善",
  jsrgjishan_info:
    "每回合每项各限一次。①当一名角色受到伤害时，你可以失去1点体力并防止此伤害，然后你与其各摸一张牌。②当你造成伤害后，你可以令一名体力值最小且你对其发动过〖积善①〗的角色回复1点体力。",
  jsrgzhenqiao: "振鞘",
  jsrgzhenqiao_info:
  ...
  jsrgzhenglve: "政略",
  jsrgzhenglve_info:
    "①一号位的回合结束时，你可以摸一张牌，然后令一名没有“猎”标记的角色获得“猎”（若一号位本回合没有造成过伤害则改为至多两名）。②你对有“猎”的角色使用牌无距离和次数限制。③每回合限一次。当你对有“猎”的角色造成伤害后，你可以摸一张牌并获得造成此伤害的牌。",
  jsrgzhenglve_info_identity:
    "①主公的回合结束时，你可以摸一张牌，然后令一名没有“猎”标记的角色获得“猎”（若主公本回合没有造成过伤害则改为至多两名）。②你对有“猎”的角色使用牌无距离和次数限制。③每回合限一次。当你对有“猎”的角色造成伤害后，你可以摸一张牌并获得造成此伤害的牌。",
  jsrghuilie: "会猎",
  jsrghuilie_info:
  ...
  jsrgshoushu: "授术",
  jsrgshoushu_info:
    "锁定技。①每轮开始时，若场上没有【太平要术】，你可以从游戏外将【太平要术】置于一名角色的装备区内。②当【太平要术】离开一名角色的装备区后，你令此牌销毁。",
  jsrgxundao: "寻道",
  jsrgxundao_info:
  ...
  sbyingmen: "盈门",
  sbyingmen_info:
    "锁定技。①游戏开始时，你将武将牌堆中随机四张武将牌置于你的武将牌上，称为“访客”。②回合开始时，你可选择是否移去任意张”访客“，然后若你的“访客”数小于4，你随机从武将牌堆中将“访客”补至四张。",
  sbpingjian: "评鉴",
  sbpingjian_info:
  ...
  jsrgduxing: "独行",
  jsrgduxing_info:
    "出牌阶段限一次。你可以视为使用一张可以指定任意名目标角色的【决斗】，且你与所有目标角色的红色手牌均视为【杀】直到此牌结算结束。",
  jsrgzhiheng: "猘横",
  jsrgzhiheng_info:
  ...
  jsrgbashi: "霸世",
  jsrgbashi_info:
    "主公技，每回合限四次，当你需要打出【杀】或【闪】时，你可以令其他吴势力角色选择是否打出一张【杀】或【闪】。若有角色响应，则视为你打出了一张【杀】或【闪】。",
  jsrg_xuyou: "承许攸",
  jsrg_xuyou_prefix: "承",
  jsrglipan: "离叛",
  jsrglipan_info:
  ...
  jsrgbiaozhao: "表召",
  jsrgbiaozhao_info:
    "准备阶段，你可以选择一名其他角色。直到你的下回合开始时或你进入濒死时，其以外的角色对其使用牌无次数限制，且其对你使用的牌造成的伤害+1。",
  jsrgyechou: "业仇",
  jsrgyechou_info:
  ...
  jsrgfuni: "伏匿",
  jsrgfuni_info:
    "锁定技。①你的攻击范围终值为0。②每轮开始时，你令任意名角色获得共计X张【影】（X为存活角色数的一半，向上取整）。③当有牌进入弃牌堆后，若其中有【影】，你于本回合使用牌无距离限制且不能被响应。",
  jsrgchuanxin: "穿心",
  jsrgchuanxin_info:
  ...
  jsrgcuifeng: "摧锋",
  jsrgcuifeng_info:
    "限定技。出牌阶段，你可以视为使用一张单目标的伤害类牌（无距离限制）。此回合结束时，若此牌目标本回合受到的伤害值之和不为1，你重置武将牌上的所有技能。",
  jsrgdengnan: "登难",
  jsrgdengnan_info:
    "限定技。出牌阶段，你可以视为使用一张非伤害类普通锦囊牌。此回合结束时，若此牌的目标均于此回合受到过伤害，你重置武将牌上的所有技能。",
  ...
  jsrgzhendan: "镇胆",
  jsrgzhendan_info:
    "①你可以将一张非基本手牌当任意基本牌使用或打出。②当你受到伤害后或每轮结束时，你摸X张牌并令该技能本轮失效（X为本轮所有角色执行过的回合数且至多为5）。",
  jsrg_simayi: "合司马懿",
  ...
  jsrgtuigu: "蜕骨",
  jsrgtuigu_info:
    "①回合开始时，你可以翻面并令你本回合的手牌上限+X，然后摸X张牌并视为使用一张【解甲归田】（X为存活角色数的一半，向下取整），目标角色不能使用以此法得到的牌直到其回合结束。②每轮结束时，若你本轮未执行过回合，则你执行一个额外回合。③当你失去装备区里的牌后，你回复1点体力。",
  jsrg_guoxun: "合郭循",
  ...
  jsrgdanxin: "丹心",
  jsrgdanxin_info:
    "你可以将X张牌当【推心置腹】使用（X为本回合此技能发动次数），你展示以此法交出与得到的牌，以此法得到♥牌的角色回复1点体力并摸一张牌，然后你至目标角色的距离+1直到回合结束。",
  jsrgfengxiang: "封乡",
  jsrgfengxiang_info:
    "锁定技，你每回合首次造成或受到伤害后，你与一名其他角色交换装备区里的所有牌。若你装备区里的牌因此减少，你摸等同于减少牌数的牌。",
  ...
  jsrgzhimeng: "执盟",
  jsrgzhimeng_info:
    "准备阶段，你可以亮出牌堆顶的Ｘ张牌（Ｘ为存活角色数），然后令所有角色同时展示一张手牌。若有角色展示的手牌花色与其他角色均不同，则这些角色从亮出牌中获得该花色的所有牌。",
  jsrgtianyu: "天予",
  jsrgtianyu_info:
    "当一张具有“伤害”标签的牌或装备牌被置入弃牌堆时，若此牌本回合内未处于过任何角色的手牌区或装备区，则你可以获得之。",
  jsrgzhuni: "诛逆",
  jsrgzhuni_info:
    "出牌阶段限一次，你可以令所有角色同时选择一名除你之外的其他角色。若有角色本回合内被指定过的次数唯一最多，则你本回合内对该角色使用牌没有次数和距离限制。",
  jsrghezhi: "合志",
  jsrghezhi_info:
    "主公技，锁定技。其他群势力角色需要因〖诛逆〗而选择角色时，改为选择你本次选择的角色。",
  jsrg_caojiewangfu: "衰曹节王甫",
  jsrg_caojiewangfu_prefix: "衰",
  jsrgzonghai: "纵害",
  jsrgzonghai_info:
    "每轮限一次。当有其他角色进入濒死状态时，你可以令其选择至多两名角色。未被选择的角色不能于此次濒死结算中使用牌，且此次濒死状态结算结束后，你对其选择的角色各造成１点伤害。",
  jsrgjueyin: "绝禋",
  jsrgjueyin_info:
    "当你于一回合内首次受到伤害后，你可以摸三张牌，然后本回合内所有角色受到的伤害+1。",
  jsrg_songhuanghou: "衰宋皇后",
  jsrg_songhuanghou_prefix: "衰",
  jsrgzhongzen: "众谮",
  jsrgzhongzen_info:
    "锁定技。①弃牌阶段开始时，你令所有手牌数小于你的角色各交给你一张手牌。②弃牌阶段结束时，若你本阶段弃置的♠牌数大于你的体力值，则你弃置所有牌。",
  jsrgxuchong: "虚宠",
  jsrgxuchong_info:
    "当你成为牌的目标后，你可以选择一项：⒈摸一张牌；⒉令当前回合角色本回合的手牌上限+2。选择完成后，你获得一张【影】。",
  jsrg_zhangjiao: "衰张角",
  jsrg_zhangjiao_prefix: "衰",
  jsrgxiangru: "相濡",
  jsrgxiangru_info:
    "当一名已受伤的其他角色／你受到致命伤害时，你／已受伤的其他角色可以交给伤害来源两张牌，然后防止此伤害。",
  jsrgwudao: "悟道",
  jsrgwudao_info:
    "觉醒技。一名角色进入濒死状态时，若你没有手牌，则你加１点体力上限并回复１点体力，然后获得〖惊雷〗。",
  jsrgjinglei: "惊雷",
  jsrgjinglei_info:
    "准备阶段，你可以选择一名其他角色Ａ，然后选择任意名手牌数之和小于Ａ的角色，令这些角色依次对Ａ造成１点雷属性伤害。",
  jsrg_yangqiu: "衰阳球",
  jsrg_yangqiu_prefix: "衰",
  jsrgsaojian: "扫奸",
  jsrgsaojian_info:
    "出牌阶段限一次，你可以观看一名其他角色的手牌，然后展示其中的一张（对该角色自己不可见）。然后该角色重复弃置一张手牌，直到其以此法弃置了五张牌／弃置了你选择的牌／没有可弃置的手牌。若其弃置完成后的手牌数大于你，则你失去１点体力。",
  mbsaojian: "扫奸",
  mbsaojian_info:
    "出牌阶段限一次，你可以观看一名其他角色的手牌并选择其中的一张（队友可为你推荐弃置的牌），然后该角色重复弃置一张手牌，直到其以此法弃置了五张牌／弃置了你选择的牌／没有可弃置的手牌。然后若其手牌数大于你，则你失去１点体力。",
  mbsaojian_info_identity:
    "出牌阶段限一次，你可以观看一名其他角色的手牌并选择其中的一张，然后该角色重复弃置一张手牌，直到其以此法弃置了五张牌／弃置了你选择的牌／没有可弃置的手牌。然后若其手牌数大于你，则你失去１点体力。",
  jsrg_dongzhuo: "衰董卓",
  jsrg_dongzhuo_prefix: "衰",
  jsrgguanshi: "观势",
  jsrgguanshi_info:
    "出牌阶段限一次，你可以将【杀】当作【火攻】对任意名角色使用。当此【火攻】对一名目标角色结算结束后，若未对其造成伤害，则此牌对其余目标角色改为以【决斗】的形式结算。",
  jsrgcangxiong: "藏凶",
  jsrgcangxiong_info:
    "当你因弃置或被其他角色得到牌而失去一张牌后，你可以用此牌蓄谋。然后若此时在你的出牌阶段内，则你摸一张牌。",
  jsrgjiebing: "劫柄",
  jsrgjiebing_info_identity:
    "觉醒技。准备阶段，若你的蓄谋牌数大于主公的体力值，则你加２点体力上限并回复２点体力，然后获得〖暴威〗。",
  jsrgjiebing_info:
    "觉醒技。准备阶段，若你的蓄谋牌数大于一号位的体力值，则你加２点体力上限并回复２点体力，然后获得〖暴威〗。",
  jsrgbaowei: "暴威",
  jsrgbaowei_info:
    "锁定技。结束阶段，若本回合内使用或打出过牌的其他角色数：大于２，则你失去２点体力；不大于２，则你对其中一名角色造成２点伤害。",
  jsrg_zhanghuan: "衰张奂",
  ...
  jsrgyansha: "宴杀",
  jsrgyansha_info:
    "准备阶段，你可以视为对任意名角色使用【五谷丰登】。此牌结算结束后，所有非目标角色可以依次将一张装备牌当作【杀】对其中一名目标角色使用。",
  jsrgqingping: "清平",
  jsrgqingping_info:
    "结束阶段，若你攻击范围内的角色均有手牌且手牌数均不大于你，则你可以摸等同于这些角色数的牌。",
  jsrg_yl_luzhi: "衰卢植",
  jsrg_yl_luzhi_prefix: "衰",
  jsrgruzong: "儒宗",
  jsrgruzong_info:
    "回合结束时，若你本回合使用牌指定过的目标角色仅有一名，则你可以将手牌数摸至与其相同。若该角色为你自己，则你可以改为令任意名其他角色将手牌摸至与你相同（均至多摸五张）。",
  jsrgdaoren: "蹈刃",
  jsrgdaoren_info:
    "出牌阶段限一次，你可以将一张手牌交给一名其他角色，然后对你与其攻击范围内均包含的所有角色各造成１点伤害。",
  jsrg_chenfan: "衰陈蕃",
  jsrg_chenfan_prefix: "衰",
  jsrggangfen: "刚忿",
  jsrggangfen_info:
    "当手牌数大于你的角色使用【杀】指定其他角色为目标时，你可以成为此【杀】的额外目标，并令所有其他角色也选择是否如此做。然后使用者展示其手牌，若其黑色手牌数小于目标数，则取消此【杀】的所有目标。",
  jsrgdangren: "当仁",
  jsrgdangren_info:
    "转换技。阳：当你需要对自己使用【桃】时，你可以视为使用之。阴：当你可以对其他角色使用【桃】时，你须视为使用之。",
  jsrg_zhangju: "衰张举",
  jsrg_zhangju_prefix: "衰",
  jsrgqiluan: "起乱",
  jsrgqiluan_info:
    "每回合限两次。当你需要使用【杀】或【闪】时，你可以弃置任意张牌，并令至多等量名其他角色选择是否代替你使用之。若有角色响应，则你摸等同与你弃置牌数的牌。",
  jsrgxiangjia: "相假",
  jsrgxiangjia_info:
  ...
  jsrgcuibing: "摧冰",
  jsrgcuibing_info:
    "锁定技，出牌阶段结束时，你将手牌摸或弃至X张（X为你攻击范围内的角色且至多为5）。若你因此弃置了牌，你弃置场上至多等量张牌，否则跳过本回合弃牌阶段。",
  jsrglangan: "阑干",
  jsrglangan_info:
    "锁定技，其他角色死亡后，你回复1点体力并摸两张牌，然后你的攻击范围-1（至多-3）。",
  jsrgchengliu: "乘流",
  jsrgchengliu_info:
    "准备阶段，你可对一名装备区内牌数小于你的角色造成X点伤害（X为你本回合发动〖乘流〗的次数），然后你可以弃置装备区里的一张牌并对一名本回合未以此法选择过的角色重复此流程。",
  jsrgjianlou: "舰楼",
  jsrgjianlou_info:
    "每回合限一次，当场上一张装备牌进入弃牌堆时，你可以弃置一张牌并获得之，然后若此牌对应的装备栏中没有牌，你使用之。",
  jsrgciyin: "辞应",
  jsrgciyin_info:
    "每回合限一次，你可以将至少X张牌当作任意基本牌使用或打出（X为此回合未进入过弃牌堆的花色数且至少为1）。此牌结算完成后，若本回合所有花色的牌均进入过弃牌堆，你将手牌摸至体力上限。",
  jsrgchendu: "陈笃",
  jsrgchendu_info:
    "锁定技，你的牌因使用、打出或弃置而进入弃牌堆时，若这些牌的数量大于你的体力值，你将这些牌交给至多等量名其他角色（若不为你的回合，选择的角色需包括当前回合角色）。",
  jsrg_simazhao: "梦司马昭",
  ...
  jsrgqiantun: "谦吞",
  jsrgqiantun_info:
    "出牌阶段限一次，你可以令一名其他角色展示至少一张手牌，然后与其拼点，其本次拼点只能从展示牌中选择。若你赢，你获得其展示的手牌；若你没赢，你获得其未展示的手牌。然后你展示手牌。",
  jsrgqiantun_tag: "invisible",
  jsrgxiezheng: "挟征",
  jsrgxiezheng_info:
    "结束阶段，你可以令至多三名角色依次将一张手牌置于牌堆顶，然后视为你使用一张【兵临城下】；此牌结算完成后若未造成伤害，你失去1点体力。",
  jsrgzhaoxiong: "昭凶",
  jsrgzhaoxiong_info:
    "限定技，准备阶段，若你已受伤且发动过〖挟征〗，你可以变更势力为晋，失去〖谦吞〗并获得〖威肆〗和〖荡异〗。",
  jsrgweisi: "威肆",
  jsrgweisi_info:
    "出牌阶段限一次，你可以选择一名其他角色，令其将任意张手牌移出游戏直到回合结束，然后视为对其使用一张【决斗】；此牌对其造成伤害后，你获得其所有手牌。",
  jsrgdangyi: "荡异",
  jsrgdangyi_info:
    "主公技，每局游戏限X次，你造成伤害时可以令此伤害+1（X为你获得此技能时的已损失体力值+1）。",
  jsrgpiqi: "辟奇",
  jsrgpiqi_info:
    "出牌阶段限两次，你可以视为使用一张无距离限制的【顺手牵羊】（不能指定相同目标），与目标距离1以内的角色本回合可以将【闪】当【无懈可击】使用。",
  jsrgzhoulin: "骤临",
  jsrgzhoulin_info:
  ...
  jsrgqinrao: "侵扰",
  jsrgqinrao_info:
    "其他角色的出牌阶段开始时，你可以将一张牌当作【决斗】对其使用。此牌结算过程中，若其手牌中有可打出的【杀】，则其必须打出；否则其展示手牌。",
  jsrgfuran: "复燃",
  jsrgfuran_info:
