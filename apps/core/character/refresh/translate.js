...
const translates = {
  ...
  jx_guanyu_prefix: "界",
  jx_wusheng: "武圣",
  jx_wusheng_info: "你可以将一张红色牌当【杀】使用或打出；你使用方块【杀】无距离限制。",
  yijue: "义绝",
  yijue_info:
  ...
  jx_simayi_prefix: "界",
  jx_fankui: "反馈",
  jx_fankui_info: "每当你受到1点伤害后，你可以获得伤害来源的一张牌。",
  jx_guicai: "鬼才",
  jx_guicai_info: "在一名角色的判定牌生效前，你可以打出一张牌代替之。",

  jx_xiahoudun: "界夏侯惇",
  jx_xiahoudun_prefix: "界",
  jx_ganglie: "刚烈",
  jx_ganglie_info:
    "每当你受到1点伤害后，可进行一次判定，若结果为红色，你对伤害来源造成1点伤害；若结果为黑色，你弃置其一张牌。",
  qingjian: "清俭",
  qingjian_info:
  ...
  jx_guojia_prefix: "界",
  tiandu: "天妒",
  tiandu_info: "每当你的判定牌生效后，你可以获得此牌。",
  jx_yiji: "遗计",
