...
const translates = {
  ...
  quhu: "驱虎",
  quhu_info:
    "出牌阶段限一次，你可以与一名体力值大于你的角色拼点：若你赢，该角色对其攻击范围内你选择的一名角色造成1点伤害；没赢，其对你造成1点伤害。",
  jieming: "节命",
  ...
  tianyi: "天义",
  tianyi_info:
    "出牌阶段限一次，你可以与一名角色拼点：若你赢，直到此阶段结束，你可以多使用一张【杀】、使用【杀】无距离限制且可以多选择一个目标；没赢，本回合你不能使用【杀】。",
  ...
  shuangxiong: "双雄",
  shuangxiong_info:
    "摸牌阶段，你可以改为进行一次判定，你获得生效后的判定牌，然后本回合你可以将与之判定结果颜色不同的一张手牌当【决斗】使用。",
  ...
  yinghun: "英魂",
  yinghun_info:
    "准备阶段，若你已受伤，你可以选择一名其他角色并选择一项：1.令其摸X张牌，然后弃置一张牌；2.令其摸一张牌，然后弃置X张牌（X为你的已损失体力值）。",
  ...
  huoshou2: "祸首",
  huoshou_info:
    "锁定技，【南蛮入侵】对你无效；其他角色使用【南蛮入侵】指定目标后，你代替其成为此牌的伤害来源。",
  zaiqi: "再起",
  zaiqi_info:
    "摸牌阶段，若你已受伤，你可以改为亮出牌堆顶的X张牌（X为你已损失的体力值），然后回复等同于其中♥牌数的体力，并获得其余的牌。",
  ...
  luanwu: "乱武",
  luanwu_info:
    "限定技，出牌阶段，你可以令所有其他角色选择一项：1.对距离自己最近的另一名角色使用一张【杀】；2.失去1点体力。",

  lusu: "鲁肃",
  haoshi: "好施",
  haoshi_info:
    "摸牌阶段，你可以多摸两张牌，然后若你的手牌数大于5，你将一半手牌（向下取整）交给手牌数最少的一名其他角色。",
  dimeng: "缔盟",
  dimeng_info:
    "出牌阶段限一次，你可以选择两名其他角色并弃置X张牌（X为这两名角色的手牌数之差），然后这两名角色交换手牌。",
  ...
  tiaoxin: "挑衅",
  tiaoxin_info:
    "出牌阶段限一次，你可以选择一名攻击范围内包含你的角色，该角色需对你使用一张【杀】，否则你弃置其一张牌。",
  zhiji: "志继",
  ...
  gongxin: "攻心",
  gongxin_info:
    "出牌阶段限一次，你可以观看一名其他角色的手牌，然后你可以选择一项：1.弃置其中一张♥牌；2.将其中一张♥牌置于牌堆顶。",

  shen_zhouyu: "神周瑜",
  shen_zhouyu_prefix: "神",
  qinyin: "琴音",
  qinyin_info:
    "弃牌阶段结束时，若你此阶段弃置过至少两张手牌，你可以令所有角色各失去1点体力，或各回复1点体力。",
  yeyan: "业炎",
  yeyan_info:
    "限定技，出牌阶段，你可以选择一项：1.对至多三名角色各造成1点火焰伤害；2.弃置四张花色均不相同的手牌并失去3点体力，再选择一至两名角色，对这些角色造成共计至多3点火焰伤害。",
  ...
  qixing_bg: "星",
  qixing_info:
    "游戏开始时，你将牌堆顶的七张牌扣置于武将牌上，称为“星”，然后你可以用任意张手牌替换等量的“星”；摸牌阶段结束时，你可以用任意张手牌替换等量的“星”。",
  kuangfeng: "狂风",
  kuangfeng2: "狂风",
  kuangfeng2_bg: "风",
  kuangfeng_info:
    "结束阶段，你可以移去一张“星”并选择一名角色，该角色受到的火焰伤害+1直到你下个回合开始。",
  dawu: "大雾",
  dawu2_bg: "雾",
  dawu2: "大雾",
  dawu_info:
    "结束阶段，你可移去任意张“星”并选择等量名角色，你防止这些角色受到的非雷电伤害直到你下个回合开始。",
