...
const translates = {
  ...
  reguanxing: "观星",
  reguanxing_info:
    "准备阶段，你可以观看牌堆顶的五张牌（存活角色小于4时改为三张），并将其以任意顺序置于牌堆顶或牌堆底，若你将〖观星〗的牌都放在了牌堆底，则你可以在结束阶段再次发动〖观星〗。",
  reluoshen: "洛神",
  reluoshen_info:
  ...
  new_rewusheng: "武圣",
  new_rewusheng_info:
    "你可以将一张红色牌当做【杀】使用或打出。你使用的方片【杀】没有距离限制。",
  new_yijue: "义绝",
  new_yijue_info:
    "出牌阶段限一次，你可以弃置一张牌并令一名有手牌的其他角色展示一张手牌。若此牌为黑色，则该角色不能使用或打出手牌，非锁定技失效且受到来自你的红桃【杀】的伤害+1直到回合结束。若此牌为红色，则你可以获得此牌，并可以令其回复1点体力。",
  new_repaoxiao: "咆哮",
  new_repaoxiao_info:
  ...
  new_qingjian: "清俭",
  new_qingjian_info:
    "每回合限一次。当你于摸牌阶段外得到牌后，你可以展示任意张牌并交给一名其他角色。然后，当前回合角色本回合的手牌上限+X（X为你给出的牌中包含的类别数）。",
  qingjian_add: "清俭",
  qingjian_add_info: "",
  new_reqingnang: "青囊",
  new_reqingnang_info:
  ...
  new_reyaowu: "耀武",
  new_reyaowu_info:
    "锁定技，当一名角色使用【杀】对你造成伤害时，若此【杀】为红色，该角色回复1点体力或摸一张牌。否则你摸一张牌。",
  reyaowu: "耀武",
  reyaowu_info:
  ...
  rezaiqi: "再起",
  rezaiqi_info:
    "结束阶段，你可以令至多X名角色选择一项：1.摸一张牌，2.令你回复1点体力（X为本回合进入过弃牌堆的红色牌数）。",
  ol_caiwenji: "界蔡琰",
  ...
  rejiushi: "酒诗",
  rejiushi_info:
    "当你需要使用【酒】时，若你的武将牌正面向上，你可以翻面，视为使用一张【酒】。当你受到伤害后，若你的武将牌背面向上且你未因此次伤害发动过〖酒诗〗，你可以翻面并从牌堆中随机获得一张锦囊牌。",
  rejiushi1: "酒诗",
  rejiushi3: "酒诗",
  rejiushi_mark: "酒诗·改",
  rejiushi_mark_info:
    "当你需要使用【酒】时，若你的武将牌正面向上，你可以翻面，视为使用一张【酒】。当你受到伤害后，若你的武将牌背面向上且你未因此次伤害发动过〖酒诗〗，你可以翻面。当你翻面时，你从牌堆中随机获得一张锦囊牌。",
  chengzhang: "成章",
  chengzhang_info:
  ...
  reyongjin: "勇进",
  reyongjin_info:
    "你失去过牌的阶段结束时，你可视为对本阶段失去牌数与你相同的任意名角色使用一张无距离限制的【杀】。此【杀】造成伤害后，你随机恢复一个装备栏（均未废除则改为将弃牌堆中一张装备牌置入你的空置装备栏）。",
  olpaoxiao: "咆哮",
  olpaoxiao2: "咆哮",
  olpaoxiao_info:
  ...
  olzaoxian_info:
    "觉醒技，准备阶段，若你武将牌上至少拥有三张“田”，则你减1点体力上限，并获得技能〖急袭〗。你于当前回合结束后进行一个额外的回合。",
  re_sunxiu: "界孙休",
  re_sunxiu_prefix: "界",
  re_caoxiu: "界曹休",
  re_caoxiu_prefix: "界",
  ...
  reshizhi: "矢志",
  reshizhi_info:
    "锁定技，若你的体力值为1，则你的【闪】视为【杀】，且当你使用对应的实体牌为一张【闪】的非转化普通【杀】造成伤害后，你回复1点体力。",
  ...
  jiezhong: "竭忠",
  jiezhong_info:
    "限定技，出牌阶段开始时，你可以将手牌补至体力上限（至多摸五张）。",
  re_caifuren: "界蔡夫人",
  ...
  rebingyi: "秉壹",
  rebingyi_info:
    "结束阶段，你可展示所有手牌。若这些牌：颜色均相同，则你可以令至多X名角色各摸一张牌（X为你的手牌数）；颜色点数均相同，则你摸一张牌。",
  re_jiaxu: "界贾诩",
  re_jiaxu_prefix: "界",
  rewansha: "完杀",
  rewansha_info:
  ...
  repingkou: "平寇",
  repingkou_info:
    "回合结束时，你可以对至多X名其他角色各造成1点伤害（X为你本回合跳过的阶段数）。若你选择的角色数小于X，则你可以令其中一名角色随机弃置装备区里的一张牌。",
  dc_liru: "界李儒",
  dc_liru_prefix: "界",
  dcmieji: "灭计",
  dcmieji_info:
  ...
  refuman: "抚蛮",
  refuman_info:
    "出牌阶段每名角色限一次。你可以弃置一张牌，令一名角色从弃牌堆中获得一张【杀】。然后其于其下个回合结束前失去此牌后，其摸一张牌；若其因使用或打出失去此牌，则改为你与其各摸一张牌。",
  re_guanzhang: "界关兴张苞",
  ...
  olhuoji: "火计",
  olhuoji_info:
    "①你可以将一张红色牌当【火攻】使用。②你使用【火攻】的作用效果改为“目标角色随机展示一张手牌A，然后你可以弃置一张与A颜色相同的手牌，对目标造成1点火属性伤害”。",
  olkanpo: "看破",
  olkanpo_info:
    "①你可以将一张黑色牌当【无懈可击】使用。②你使用的【无懈可击】不可被响应。",
  xinwangxi: "忘隙",
  xinwangxi_info:
  ...
  remingjian: "明鉴",
  remingjian_info:
    "出牌阶段限一次。你可以将所有手牌交给一名其他角色，然后该角色于其下个回合获得如下效果：1.手牌上限与使用【杀】的次数上限+1；2.当该角色首次造成伤害后，你发动一次〖恢拓〗。",
  rexingshuai: "兴衰",
  rexingshuai_info:
  ...
  requji: "去疾",
  requji_info:
    "出牌阶段限一次，你可以弃置X张牌（X为你已损失的体力值）并令至多X名角色回复1点体力，然后仍处于受伤状态的目标角色摸一张牌。若你以此法弃置了黑色牌，你失去1点体力。",
  rejunbing: "郡兵",
  rejunbing_info:
  ...
  regongao: "功獒",
  regongao_info:
    "锁定技。一名其他角色首次进入濒死状态时，你增加1点体力上限，然后回复1点体力。",
  rejuyi: "举义",
  rejuyi_info:
  ...
  re_xushu_prefix: "界",
  rejianxiong_old: "奸雄",
  rejianxiong_old_info:
    "当你受到伤害后，你可以摸一张牌或获得对你造成伤害的牌。",
}
