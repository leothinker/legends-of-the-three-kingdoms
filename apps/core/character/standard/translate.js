const translates = {
  ...
  xuchu: "许褚",
  luoyi: "裸衣",
  luoyi_info: "摸牌阶段，你可以少摸一张牌，然后你本回合使用【杀】或【决斗】造成的伤害+1。",

  guojia: "郭嘉",
  tiandu: "天妒",
  tiandu_info: "当你的判定牌生效后，你可以获得此牌。",
  yiji: "遗计",
  yiji_info: "当你受到1点伤害后，你可以观看牌堆顶的两张牌，然后将这些牌交给任意角色。",

  zhenji: "甄姬",
  luoshen: "洛神",
  luoshen_info: "准备阶段，你可以进行判定，当黑色判定牌生效后，你获得之并可以重复此流程。",
  qingguo: "倾国",
  ...
  qingnang: "青囊",
  qingnang_info: "出牌阶段限一次，你可以弃置一张手牌，然后令一名角色回复1点体力。",
