const translates = {
  ...
  tieji: "铁骑",
  tieji_info:
    "你的【杀】指定目标后，你可以进行判定，若结果为红色，该角色不能使用【闪】。",
  ...
  jiuyuan: "救援",
  jiuyuan_info:
    "主公技，锁定技，其他吴势力角色对你使用的【桃】回复的体力值+1。",
  ...
  fanjian: "反间",
  fanjian_info:
    "出牌阶段限一次，你可以令一名其他角色猜一种花色，然后获得你的一张手牌并展示之，如果猜错花色，该角色受到1点伤害。",
  ...
  luoyi: "裸衣",
  luoyi_info:
    "摸牌阶段，你可以少摸一张牌，然后本回合你的【杀】或【决斗】造成的伤害+1。",
  ...
  lijian: "离间",
  lijian_info:
    "出牌阶段限一次，你可以弃置一张牌，然后令一名男性角色视为对另一名男性角色使用一张【决斗】。",
  biyue: "闭月",
  ...
  yicong: "义从",
  yicong_info:
    "锁定技，当你的体力值大于2时，你计算与其他角色的距离-1；当你的体力值不大于2时，其他角色计算与你的距离+1。",

  panfeng: "潘凤",
  kuangfu: "狂斧",
  kuangfu_info:
    "锁定技，出牌阶段限一次，你使用【杀】对其他角色造成伤害后，若其体力值小于你，你摸两张牌，若其体力值不小于你，你失去1点体力。",

  ganfuren: "甘夫人",
  shenzhi: "神智",
  shenzhi_info:
    "你的回合开始时，你可以弃置所有手牌，然后若你弃置的牌数大于你的体力值，你回复1点体力。",
  shushen: "淑慎",
  shushen_info:
  ...
  xiaoguo: "骁果",
  xiaoguo_info:
    "其他角色的回合结束时，你可以弃置一张基本牌，若如此做，其需弃置一张装备牌，否则你对其造成1点伤害。",
}
