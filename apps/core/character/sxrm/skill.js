  ...
  sxrmsigu: {
    ...
    ai: {
      ...
      result: {
        target(player, target) {
          if (
            (target.hasSkillTag("maixie") || target.hasSkillTag("maixie_hp")) &&
            get.attitude(player, target) < 0
          ) {
            return 0
          }
          ...
          if (
            (target.hasSkillTag("maixie") || target.hasSkillTag("maixie_hp")) &&
            get.attitude(player, target) > 0 &&
            target.getHp() + target.hujia >= 3
          ) {
            return 2
          }
          if (
            get.attitude(player, target) > 0 &&
            target.getHp() + target.hujia >= 4
          ) {
            return 1
          }
          if (
            get.attitude(player, target) === 0 &&
            target.getHp() + target.hujia >= 2
          ) {
            return 1
          }
          return 0
