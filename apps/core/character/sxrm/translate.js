...
const translates = {
  ...
  xianger: "香饵",
  xianger_info:
    "使命技，出牌阶段限一次，你可以令一名角色于其下个结束阶段回复2点体力，期间其不能使用点数大于6的牌。失败：若期间其受到的伤害值小于2，你减1点体力上限。",
  mieguo: "灭虢",
  mieguo_info:
    "使命技，额定回合结束后，你可以获得一名其他角色至多三张牌并令其选择等量的角色，然后你执行一个不能对其选择角色使用牌的额外回合。失败：若此额外回合你未使用过牌，你减1点体力上限。",
}
