...
const translates = {
  ...
  sxrmzongheng: "纵横",
  sxrmzongheng_info:
    "准备阶段，你可以观看两名其他角色的手牌，展示并获得其中一张，然后你弃置另一名角色与你此法展示牌花色、点数、类型相同的手牌各一张。",
  sxrmduibian: "对辩",
  ...
  sxrmmiehai: "灭害",
  sxrmmiehai_info:
    "你可以将两张牌当作无距离次数限制的刺【杀】使用。此【杀】结算完成后，此过程中正面失去♠牌且已受伤的角色摸两张牌并回复1点体力。",
  sxrm_lvboshe: "疑吕伯奢",
  ...
  sxrmshefu: "设伏",
  sxrmshefu_info:
    "结束阶段，你可以扣置一张牌为“伏兵”；其他角色于你的回合外使用手牌时，你可以移去一张颜色与类别均与此牌相同的“伏兵”，令此牌无效。",
  sxrm_fuhuanghou: "疑伏寿",
  sxrm_fuhuanghou_prefix: "疑",
  sxrmmitu: "密图",
  sxrmmitu_info:
    "准备阶段，你可以令至多三名已受伤角色各摸一张牌并展示之，然后令这些角色依次选择是否与你指定的另一名角色拼点，拼点赢的角色视为对没赢的角色使用一张【杀】。每有一名角色未用以此法展示的牌进行拼点，你减少1点体力上限。",
  sxrmqianliu: "潜流",
  sxrmqianliu_info:
    "与你距离1以内的角色成为【杀】的目标后，你可以观看牌堆底四张牌并以任意顺序置于牌堆顶或牌堆底；若这些牌花色均不相同，你可以展示并获得这些牌。",
  sxrm_xunyu: "疑荀彧",
  sxrm_xunyu_prefix: "疑",
  sxrmhuice: "迴策",
  sxrmhuice_info:
    "出牌阶段限一次，你可以依次与两名角色拼点，于一次拼点中赢的角色对另一次拼点中没赢的角色各造成1点伤害。",
  sxrmyihe: "异合",
  sxrmyihe_info:
  ...
  sxrmzhengsi: "争嗣",
  sxrmzhengsi_info:
    "出牌阶段，你可以选择包括你在内的三名有手牌的角色，令其中一名角色先展示一张手牌，然后其余角色同时展示一张手牌。以此法展示牌点数最大的角色弃置两张手牌，以此法展示牌点数最小的角色失去1点体力。",
  sxrmchengming: "承命",
  sxrmchengming_info:
    "出牌阶段结束时，若你此阶段发动过〖争嗣〗，且你在此阶段成为过〖争嗣〗目标的角色中：手牌数最大，你可以回复2点体力；体力值最大，你可以获得这些角色各一张牌。",
  sxrm_wanghou: "疑王垕",
  sxrm_wanghou_prefix: "疑",
  sxrmjugu: "聚谷",
  sxrmjugu_info:
    "准备阶段，你可以依次选择任意名角色至多共计五张牌，将这些牌正面向上置于牌堆顶；此回合结束时，这些角色获得牌堆顶各自以此法放置的牌（没有则跳过），然后各摸一张牌。",
  //蚀心入魔·慢
  sxrm_guanyu: "魔关羽",
  ...
  sxrmhuoe: "火厄",
  sxrmhuoe_info:
    "结束阶段，你可以视为对至多四名其他角色使用一张【火攻】，若你有可弃置的牌，须弃置之并取消剩余目标，否则其观看你的手牌。结算结束后你分配因此展示的牌，若点数之和小于13，你失去1点体力。",
  sxrmtanduo: "贪惰",
  ...
  sxrmhuaibing: "怀兵",
  sxrmhuaibing_info:
    "准备阶段，你可选择两名有牌的角色，获得这些角色各一张手牌（为你则跳过），然后你展示手牌，令其中体力值较少的角色下个摸牌阶段摸牌数、出牌阶段出【杀】次数、弃牌阶段手牌上限改为其中红色牌的数量。",
  sxrm_luxun: "慢陆逊",
  sxrm_luxun_prefix: "慢",
  sxrmchanyu: "谄谀",
  sxrmchanyu_info:
    "出牌阶段限一次，你可以令一名其他角色摸其体力值张牌并与其用各自点数最小的牌拼点，然后双方展示手牌：赢的角色可以交换双方一种颜色或类别的所有手牌。",
  sxrmchanyu_tag: "invisible",
  sxrmcongfeng: "从风",
  sxrmcongfeng_info:
    "转换技，你使用牌或成为牌的目标后，你可以阳：与使用者各摸一张牌；阴：弃置使用者两张牌。",
  sxrm_lvmeng: "慢吕蒙",
  sxrm_lvmeng_prefix: "慢",
  sxrmkongzhi: "空志",
  sxrmkongzhi_info:
    "锁定技，你使用【杀】指定唯一目标后，获得其至多三张牌；若你已受伤，普通锦囊牌对你无效且你的基本牌均视为【闪】。",
  sxrmbizha: "鄙诈",
  sxrmbizha_info:
    "结束阶段，你可以摸一张牌并拼点：若其没赢，其失去2点体力并令你观看其手牌，你可使用其中至多两张点数小于其拼点牌的牌；若你没赢，你减少1点体力上限。",
  sxrm_pangde: "慢庞德",
  sxrm_pangde_prefix: "慢",
  sxrmnuozhan: "搦战",
  sxrmnuozhan_info:
    "准备阶段，你可摸一张牌并令一名其他角色声明一个伤害类牌的牌名，然后你令你或其视为对对方使用此牌且伤害+1；若此牌未对目标造成伤害，使用者失去1点体力且你可以对相同角色重复此流程。",
  sxrm_yanwen: "慢颜良文丑",
  sxrm_yanwen_prefix: "慢",
  sxrmhaibian: "骇变",
  sxrmhaibian_info:
    "一名角色的回合开始时，若你上回合使用过手牌，则上回合最后一张黑色牌和红色牌的使用者可以依次视为使用一张【决斗】。",
  sxrmqiewang: "怯亡",
  sxrmqiewang_info:
    "锁定技，你距离1以内的角色受到伤害后，你摸一张牌，令你的手牌本回合均视为【无懈可击】。",
  //蚀心入魔·嗔
  sxrm_zhouyu: "魔周瑜",
  sxrm_zhouyu_prefix: "魔",
  sxrmjiehuo: "劫火",
  sxrmjiehuo_info:
    "使命技，回合开始时，你可以令场上下次出现的伤害改为3点火焰伤害。失败：若造成此伤害的角色不为你：你减1点体力上限。",
  sxrmxianger: "香饵",
  sxrmxianger_info:
    "使命技，出牌阶段限一次，你可以令一名角色于其下个结束阶段回复2点体力，期间其不能使用点数大于6的牌。失败：期间其受到的伤害值小于2：你减1点体力上限。",
  sxrmmieguo: "灭虢",
  sxrmmieguo_info:
    "使命技，额定回合结束后，你可以获得一名其他角色至多三张牌并令其指定等量角色，然后你执行一个不能对其指定角色使用牌的额外回合；失败：此回合你未使用过牌：你减1点体力上限。",
  sxrm_sunshangxiang: "嗔孙尚香",
  sxrm_sunshangxiang_prefix: "嗔",
  sxrmjiaozong: "骄纵",
  sxrmjiaozong_info:
    "准备阶段或当你成为【杀】的目标后，你可以移动场上一张装备牌至一名角色装备区内，其本回合不能使用与之颜色相同的牌且受到的伤害+1。",
  sxrmfusui: "妇随",
  sxrmfusui_info: `限定技，出牌阶段，你可以选择一名其他男性角色的一个非标签技能，你令其失去此技能，然后你与其获得【${get.poptip("sxrmbiyi")}】并防止你们本轮受到的伤害。`,
  sxrmbiyi: "比翼",
  sxrmbiyi_info:
    "转换技，你视为拥有：阳：因【妇随】失去的技能；阴：【枭姬】。当你发动上述对应技能后，切换本技能状态。",
  sxrm_zhangzhao: "嗔张昭",
  sxrm_zhangzhao_prefix: "嗔",
  sxrmxiezhong: "挟众",
  sxrmxiezhong_info:
    "准备阶段，你可令场上半数角色（向上取整）依次选择并执行一项：1.摸两张牌，失去 1 点体力；2.将两张牌当【杀】使用。然后你可以令另一名角色执行两次被选择较多的一项。",
  sxrmqishi: "乞施",
  ...
  sxrmwanli: "万利",
  sxrmwanli_info:
    "首轮开始时，你可以交给一名其他角色任意张牌，第四轮结束时若你存活，其交给你三倍数量的牌（不足则全给并失去所有技能）；若其已还牌或死亡，你摸牌阶段多摸三张牌。",
  sxrmlishui: "理说",
  sxrmlishui_info:
    "当你成为黑色牌的目标时，你可以摸一张牌并与一名未还牌的“万利”角色拼点：若你赢，其提前一轮还牌（不会提前到本轮前）。",
  sxrm_chen_caocao: "嗔曹操",
  sxrm_chen_caocao_prefix: "嗔",
  sxrmlanjiao: "揽娇",
  sxrmlanjiao_info:
    "出牌阶段对每名角色限一次，你可以展示一名其他角色两张手牌，然后你获得展示的牌；其可以在你展示这些牌时失去1点体力并摸一张牌，令你重新展示。若你一回合内因此获得过♥和♦牌，此技能本回合失效。",
  sxrm_zhugeliang: "嗔诸葛亮",
  sxrm_zhugeliang_prefix: "嗔",
  sxrmbingqu: "并驱",
  sxrmbingqu_info:
    "准备阶段，你可以与一名其他角色各声明一种普通锦囊牌，然后双方依次将半数手牌（向上取整）当对方声明的牌使用。",
  sxrmfanxin: "燔心",
  ...
  sxrmfubei: "伏备",
  sxrmfubei_info:
    "出牌阶段限一次，你可以将手牌摸至体力上限，然后将两张牌正面朝上置于牌堆顶前十张的任意位置（对其他角色可见）；每名角色回合结束时，若牌堆顶的牌正面朝上，你须对其造成1点伤害。",
  sxrmdancui: "殚瘁",
  ...
  sxrmzhaduo: "诈夺",
  sxrmzhaduo_info:
    "结束阶段，你可以获得两名其他角色各一张牌，视为对其中一名角色使用一张【杀】，然后另一名角色视为对你使用一张【决斗】；在和其中一名角色的结算过程中，你视为拥有另一名角色的所有技能。",
  sxrm_caoren: "嗔曹仁",
  sxrm_caoren_prefix: "嗔",
  sxrmyangbei: "佯北",
  sxrmyangbei_info:
    "准备阶段和结束阶段，你可以翻面并摸三张牌。当你使用【杀】或普通锦囊牌指定唯一目标后，其可以弃置所有手牌令此技能本回合失效。",
  sxrmyinfeng: "阴锋",
  sxrmyinfeng_info:
    "锁定技，当你每回合首次造成伤害后，将受伤角色体力上限减至其体力值且其接下来造成和受到的伤害均视为失去体力，直到你下回合开始。",
}
