const dynamicTranslates = {
  ...
  jiaozhao(player) {
    var num = player.countMark("danxin")
    if (num > 2) {
      return "出牌阶段每种类别限声明一次，你可以展示一张手牌，然后声明一种基本牌或普通锦囊牌的牌名，本回合你可以将此牌当声明的牌使用。"
    }
    if (num > 1) {
      return "出牌阶段限一次，你可以展示一张手牌，然后声明一种基本牌或普通锦囊牌的牌名，本回合你可以将此牌当声明的牌使用（不能指定自己为目标）。"
    }
    if (num > 0) {
      return "出牌阶段限一次，你可以展示一张手牌，然后选择一名距离最近的其他角色，其声明一种基本牌或普通锦囊牌的牌名，本回合你可以将此牌当声明的牌使用（不能指定自己为目标）。"
    }
    return "出牌阶段限一次，你可以展示一张手牌，然后选择一名距离最近的其他角色，其声明一种基本牌的牌名，本回合你可以将此牌当声明的牌使用（不能指定自己为目标）。"
  },
  funan(player) {
