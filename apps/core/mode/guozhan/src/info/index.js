...
export const substitute = {
  gz_shichangshi: [
    ...
    //似了
    [
      "gz_scs_zhangrang_dead",
      ["character:scs_zhangrang_dead", "die:shichangshi"],
    ],
    [
      "gz_scs_zhaozhong_dead",
      ["character:scs_zhaozhong_dead", "die:shichangshi"],
    ],
    [
      "gz_scs_sunzhang_dead",
      ["character:scs_sunzhang_dead", "die:shichangshi"],
    ],
    ...
    [
      "gz_scs_guosheng_dead",
      ["character:scs_guosheng_dead", "die:shichangshi"],
    ],
