export default {
  ...
  gz_yiji: "遗计",
  gz_yiji_info:
    "当你受到伤害后，你可以观看牌堆顶的两张牌，并将其交给任意角色。",
  ...
  gz_paoxiao: "咆哮",
  gz_paoxiao_info:
    "锁定技，你使用【杀】无数量限制；当你于一回合内使用第二张【杀】时，摸一张牌。",
  ...
  gz_shushen: "淑慎",
  gz_shushen_info:
    "当你回复1点体力后，你可令一名其他角色摸一张牌（若其没有手牌则改为摸两张牌）。",
  ...
  gz_keji: "克己",
  gz_keji_info:
    "锁定技，若你没有在出牌阶段内使用过颜色不同的牌，则你本回合的手牌上限+4。",
  gz_mouduan: "谋断",
  gz_mouduan_info:
  ...
  gz_xiaoji: "枭姬",
  gz_xiaoji_info:
    "当你失去装备区里的牌后，你可以摸一张牌。若你不是当前回合角色，则你改为摸三张牌。",
  ...
  gz_wushuang: "无双",
  gz_wushuang_info:
    "锁定技。①当你使用【杀】指定一名角色为目标后，其需使用两张【闪】才能抵消；②当你使用【决斗】指定其他角色为目标后，或成为其他角色使用【决斗】的目标后，其每次响应需打出两张【杀】。③当你使用非转化的【决斗】选择目标后，你可为此【决斗】增加两个目标。",
  ...
  gz_duanchang: "断肠",
  gz_duanchang_info:
    "锁定技，当你死亡时，你令杀死你的角色失去一张武将牌上的所有技能。",
  ...
  gz_kurou: "苦肉",
  gz_kurou_info:
    "出牌阶段限一次，你可以弃置一张牌并失去1点体力，然后摸三张牌并令你本回合出牌阶段使用【杀】的次数+1。",

  gz_suishi: "随势",
  // gz_suishi2: "随势",
  gz_suishi_info:
    "锁定技，其他角色进入濒死状态时，若伤害来源与你势力相同，你摸一张牌；其他角色死亡时，若其与你势力相同，你失去1点体力或弃置所有手牌。",
