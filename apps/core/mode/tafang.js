  ...
  return {
      ...
      tafang_mech_gongchengche_skill: {
        ...
        content() {
          ...
          if (list.length) {
            ...
            game.logv(player, "tafang_mech_gongchengche_skill", [target]).node.text.style.display =
              "none"
          }
        },
      },
    ...
    translate: {
      ...
      tafang_mech_nengliangqiu_skill_info:
        "每一轮令距离3格以内的所有友方角色摸一张牌，距离1以内改为摸2张。",
