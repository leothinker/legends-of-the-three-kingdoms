...
export const otherMenu = (/** @type { boolean | undefined } */ connectMenu) => {
  if (connectMenu) {
    return
  }
  /**
  ...
  ;(() => {
    ...
    var _nodedamage = ui.create.div(".menubutton", "伤害", row1, clickrow1)
    var _noderecover = ui.create.div(".menubutton", "回复", row1, clickrow1)
    var _nodedraw = ui.create.div(".menubutton", "摸牌", row1, clickrow1)
    var _nodediscard = ui.create.div(".menubutton", "弃牌", row1, clickrow1)
    var _nodelink = ui.create.div(".menubutton", "横置", row1, clickrow1)
    var _nodeturnover = ui.create.div(".menubutton", "翻面", row1, clickrow1)
    ...
    var _nodex1 = ui.create.div(".menubutton", "一", row2, clickrow2)
    var _nodex2 = ui.create.div(".menubutton", "二", row2, clickrow2)
    var _nodex3 = ui.create.div(".menubutton", "三", row2, clickrow2)
    var _nodex4 = ui.create.div(".menubutton", "四", row2, clickrow2)
    var _nodex5 = ui.create.div(".menubutton", "五", row2, clickrow2)
    ...
    menuUpdates.push(() => {
      ...
      if (
        ...
        if (
          ...
          (game.me &&
            (game.me._trueMe ||
              game.hasPlayer((current) => current._trueMe === game.me))) ||
          !game.phaseNumber ||
          _status.qianlidanji
        ) {
          nodereplace.classList.add("unselectable")
    ...
    node._initLink = () => {
      ...
      store.openCursor().onsuccess = (e) => {
        ...
        if (cursor) {
          ...
          lib.videos.sort((a, b) => parseInt(b.time, 10) - parseInt(a.time, 10))
          ...
          importVideo.lastChild.onclick = () => {
            ...
            fileReader.onload = (fileLoadedEvent) => {
              ...
              for (var deletei = 0; deletei < 5; deletei++) {
                if (
                  videos.length >= parseInt(lib.config.video, 10) &&
                  videos.length
                ) {
