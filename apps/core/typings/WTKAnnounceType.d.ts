declare interface WTKAnnounceType {
  // Apperaence 外观区域
  // 用于关于三国杀外观方面的通知
   ...
   * @param values - 主题名称
   */
  "WTK.Apperaence.Theme.onChanging": AnnounceFunction<string>
   ...
   * @param values - 主题名称
   */
  "WTK.Apperaence.Theme.onChanged": AnnounceFunction<string>
   ...
   * @param values - 主题名称
   */
  "WTK.Apperaence.Theme.onChangeFinished": AnnounceFunction<string>
   ...
   * @param values - 空对象
   */
  "WTK.Game.Event.GameStart": AnnounceFunction<object>
   ...
   * @param values - 扩展名称
   */
  "WTK.Init.Extension.onLoad": AnnounceFunction<string>
}
...
declare class Announce {
   ...
   * @param values - 要推送的数据
   */
  publish<Type extends WTKAnnounceType, Name extends keyof Type>(
    name: Name,
   ...
   */
  subscribe<Type extends WTKAnnounceType, Name extends keyof Type>(
    name: Name,
    method: Type[Name],
  ): Type[Name]
   ...
   */
  unsubscribe<Type extends WTKAnnounceType, Name extends keyof Type>(
    name: Name,
    method: Type[Name],
  ): Type[Name]
}
