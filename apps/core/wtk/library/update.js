 ...
 * @param { string } [options.username = 'libwtk'] 仓库拥有者
 * @param { string } [options.repository = 'wtk'] 仓库名称
 ...
 * @param {string} [owner = 'libwtk'] GitHub上拥有存储库的用户名或组织名称。
 * @param {string} [repo = 'wtk'] GitHub存储库的名称
 * @returns {Promise<{
 * 	path: string;
 * 	mode: string;
 * 	type: "blob" | "tree";
