    ...
    node._initLink = function () {
                  ...
                  if (lib.node && lib.node.fs) {
                    ...
                    var getDirectory = function () {
                      if (directoryList.length) {
                        ...
                        window.resolveLocalFileSystemURL(wtkInitialized + dir, function (entry) {
                          var writeFile = function () {
                            if (filelist.length) {
      ...
      var removeFile = function (selected, page) {
        if (lib.node && lib.node.fs) {
          ...
          window.resolveLocalFileSystemURL(wtkInitialized + page.currentpath, function (entry) {
            var unlink = function () {
              if (selected.length) {
        ...
        if (page.deletebutton.classList.contains("active")) {
          if (confirm("确认删除" + this.innerHTML + "文件夹？（此操作不可撤销）")) {
            if (lib.node && lib.node.fs) {
              ...
              window.resolveLocalFileSystemURL(wtkInitialized + this.path, function (entry) {
      ...
      var enterDirectory = function (page, path) {
        ...
        var createDir = function (str) {
          if (lib.node && lib.node.fs) {
            ...
            window.resolveLocalFileSystemURL(wtkInitialized + path, function (entry) {
