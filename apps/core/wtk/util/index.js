...
export const wtkInitialized = localStorage.getItem("wtk_inited")
...
export const device =
  wtkInitialized !== "nodejs"
    ? userAgentLowerCase.includes("android")
      ? "android"
      : userAgentLowerCase.includes("iphone") ||
          userAgentLowerCase.includes("ipad") ||
          isIPadOSMasqueradingAsMac
        ? "ios"
        : void 0
    : void 0

// export const androidNewStandardApp = device === "android" && typeof window.WTKAndroidBridge != "undefined";
