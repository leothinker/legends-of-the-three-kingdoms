...
对象参数的类型定义在 [`Player/type.d.ts`](../apps/core/wtk/library/element/Player/type.d.ts) 中。接口通常按以下规则命名：
...
下表按 [`Player/type.d.ts`](../apps/core/wtk/library/element/Player/type.d.ts) 中的接口整理。字段的最终清单和精确类型以该文件为准。
